...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
            ...
            ?>
              <div class="card card-primary col-lg-12">
                ...
                <form role="form" action="../include/admin.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">About Profile Pic(600X600)</label>
            ...
            ?>
              <div class="card card-primary col-lg-12">
                ...
                <form role="form" action="../include/admin.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group col-6">
                      <label for="exampleInputEmail1">Project Type</label><br>
                      <select name="type" class="form-control">
                        <option value="Business">Business</option>
                        <option value="Ongoing Business">Ongogoing Business</option>
                    ...
                    <div class="form-group col-6">
                      <label for="exampleInputEmail1">Project Image (800X600)</label>
              ...
              ?>
                <div class="card card-primary col-lg-12">
                  ...
                  <form role="form" action="../include/admin.php" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Choose Background Image (1920X1280)</label>
              ...
              ?>
                ...
                <div class="card card-primary col-lg-12">
                  ...
                  <form role="form" action="../include/admin.php" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Choose Background Image (1920X1080)</label>
                        <input type="file" class="form-control" name="background">
                      </div>
              ...
              ?>
                ...
                <div class="card card-primary col-lg-12">
                  ...
                  <form role="form" action="../include/admin.php" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Siteicon(160X160)</label>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2021 <a href="https://raxonomus.com">Md Fazle Rabbi</a></strong>
      All rights reserved.
